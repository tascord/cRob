...
***
## Forewarning
This project is still in a pre-release state, the commands, pre-installed modules & Wiki aren't completely ready yet. If you find any issues in the, don't be surprised. [See Issues](https://github.com/tascord/cRob#Bugs).
